...
from birdset_resample import BirdSet, anypath, run_benchmark_comparison
...
def main() -> None:
    ...
    parser.add_argument(
        "--target_dir", type=str, required=True, help="Target directory for benchmark test outputs"
    )
    parser.add_argument(
        "--split",
        type=str,
    ...
    parser.add_argument(
        "--quick", action="store_true", help="Run a quick benchmark with fewer configurations"
    )
