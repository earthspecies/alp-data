...
class TestPassthrough:
    ...
    def test_passthrough_passes_fields(self) -> None:
        """Test passthrough preserves prompt field from source."""
        ...
        # Passthrough renders {{ prompt }} from input into messages
        messages = json.loads(result["messages"])
...
class TestPromptRegistry:
    ...
    def test_register_and_get(self) -> None:
        ...
        template = ConversationTemplate(name="test_register_get", variants=[conv])
    ...
    def test_register_duplicate_raises(self) -> None:
        ...
        register_prompt(ConversationTemplate(name="test_duplicate", variants=[conv]))
    ...
    def test_list_prompts(self) -> None:
        ...
        register_prompt(ConversationTemplate(name="test_list_item", variants=[conv]))
    ...
    def test_register_from_config(self) -> None:
        """Test registering from ConversationTemplateConfig."""
