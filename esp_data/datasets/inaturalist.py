    ...
    **Additional Fields:**
    ...
    schema = DatasetSchema(
        columns=[
            ...
            ColumnSchema(
                name="species_scientific_original",
                dtype="str",
                required=False,
                description="Original scientific name before normalization",
            ),
            ColumnSchema(
                name="audiocap_id",
                dtype="str",
            ...
            ColumnSchema(
                ...
                dtype="str",
                required=False,
                description="Source dataset (e.g. iNaturalist)",
            ),
            ColumnSchema(
                name="species_common",
                dtype="str",
            ...
            ColumnSchema(
                ...
                dtype="str",
                required=False,
                description="Start time offset within the audio file",
            ),
            ColumnSchema(
            ...
            ColumnSchema(
                ...
                dtype="int",
                required=False,
                description="iNaturalist sound observation identifier",
            ),
            ColumnSchema(
                name="data_source",
                dtype="str",
            ...
            ColumnSchema(
                ...
                dtype="str",
                required=False,
                description="Previous path to the audio file (deprecated)",
            ),
            ColumnSchema(
                name="32khz_path",
                dtype="str",
