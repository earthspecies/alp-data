...
SPECIES_INFO_PATH = f"{DATA_HOME}/wabad/v0.1.0/raw/gbif_labels.csv"
...
class WABAD(Dataset):
    ...
    info = DatasetInfo(
        ...
        owner="benjamin",
        split_paths={
            "all": f"{DATA_HOME}/wabad/v0.1.0/raw/all_info_gbif_v3.csv",
            "CAT": f"{DATA_HOME}/wabad/v0.1.0/raw/CAT_info_gbif_v2.csv",
            "POZO": f"{DATA_HOME}/wabad/v0.1.0/raw/POZO_info_gbif_v2.csv",
            "BRE": f"{DATA_HOME}/wabad/v0.1.0/raw/BRE_info_gbif_v2.csv",
            "EFFOR": f"{DATA_HOME}/wabad/v0.1.0/raw/EFFOR_info_gbif_v2.csv",
            "MONTEB": f"{DATA_HOME}/wabad/v0.1.0/raw/MONTEB_info_gbif_v2.csv",
            "CB": f"{DATA_HOME}/wabad/v0.1.0/raw/CB_info_gbif_v2.csv",
            "FEU": f"{DATA_HOME}/wabad/v0.1.0/raw/FEU_info_gbif_v2.csv",
            "BIAL": f"{DATA_HOME}/wabad/v0.1.0/raw/BIAL_info_gbif_v2.csv",
            "SPMCO": f"{DATA_HOME}/wabad/v0.1.0/raw/SPMCO_info_gbif_v2.csv",
            "OIO": f"{DATA_HOME}/wabad/v0.1.0/raw/OIO_info_gbif_v2.csv",
            "OESF": f"{DATA_HOME}/wabad/v0.1.0/raw/OESF_info_gbif_v2.csv",
            "QR": f"{DATA_HOME}/wabad/v0.1.0/raw/QR_info_gbif_v2.csv",
            "HAG": f"{DATA_HOME}/wabad/v0.1.0/raw/HAG_info_gbif_v2.csv",
            "VIL": f"{DATA_HOME}/wabad/v0.1.0/raw/VIL_info_gbif_v2.csv",
            "RFP": f"{DATA_HOME}/wabad/v0.1.0/raw/RFP_info_gbif_v2.csv",
            "HAK": f"{DATA_HOME}/wabad/v0.1.0/raw/HAK_info_gbif_v2.csv",
            "SLOB": f"{DATA_HOME}/wabad/v0.1.0/raw/SLOB_info_gbif_v2.csv",
            "BERB": f"{DATA_HOME}/wabad/v0.1.0/raw/BERB_info_gbif_v2.csv",
            "COU": f"{DATA_HOME}/wabad/v0.1.0/raw/COU_info_gbif_v2.csv",
            "OLIV": f"{DATA_HOME}/wabad/v0.1.0/raw/OLIV_info_gbif_v2.csv",
            "EVROS": f"{DATA_HOME}/wabad/v0.1.0/raw/EVROS_info_gbif_v2.csv",
            "FNCA": f"{DATA_HOME}/wabad/v0.1.0/raw/FNCA_info_gbif_v2.csv",
            "RGU": f"{DATA_HOME}/wabad/v0.1.0/raw/RGU_info_gbif_v2.csv",
            "CRUZ": f"{DATA_HOME}/wabad/v0.1.0/raw/CRUZ_info_gbif_v2.csv",
            "JUNCA": f"{DATA_HOME}/wabad/v0.1.0/raw/JUNCA_info_gbif_v2.csv",
            "PINA": f"{DATA_HOME}/wabad/v0.1.0/raw/PINA_info_gbif_v2.csv",
            "GTLU": f"{DATA_HOME}/wabad/v0.1.0/raw/GTLU_info_gbif_v2.csv",
            "MAPIMI": f"{DATA_HOME}/wabad/v0.1.0/raw/MAPIMI_info_gbif_v2.csv",
            "SAL": f"{DATA_HOME}/wabad/v0.1.0/raw/SAL_info_gbif_v2.csv",
            "ARD": f"{DATA_HOME}/wabad/v0.1.0/raw/ARD_info_gbif_v2.csv",
            "MARTI": f"{DATA_HOME}/wabad/v0.1.0/raw/MARTI_info_gbif_v2.csv",
            "DYOM": f"{DATA_HOME}/wabad/v0.1.0/raw/DYOM_info_gbif_v2.csv",
            "VER": f"{DATA_HOME}/wabad/v0.1.0/raw/VER_info_gbif_v2.csv",
            "SCHG": f"{DATA_HOME}/wabad/v0.1.0/raw/SCHG_info_gbif_v2.csv",
            "GLEN": f"{DATA_HOME}/wabad/v0.1.0/raw/GLEN_info_gbif_v2.csv",
            "HONDO": f"{DATA_HOME}/wabad/v0.1.0/raw/HONDO_info_gbif_v2.csv",
            "NL": f"{DATA_HOME}/wabad/v0.1.0/raw/NL_info_gbif_v2.csv",
            "BRCAS": f"{DATA_HOME}/wabad/v0.1.0/raw/BRCAS_info_gbif_v2.csv",
            "NAV": f"{DATA_HOME}/wabad/v0.1.0/raw/NAV_info_gbif_v2.csv",
            "KAR": f"{DATA_HOME}/wabad/v0.1.0/raw/KAR_info_gbif_v2.csv",
            "BUR": f"{DATA_HOME}/wabad/v0.1.0/raw/BUR_info_gbif_v2.csv",
            "KIB": f"{DATA_HOME}/wabad/v0.1.0/raw/KIB_info_gbif_v2.csv",
            "SCHF": f"{DATA_HOME}/wabad/v0.1.0/raw/SCHF_info_gbif_v2.csv",
            "TAM": f"{DATA_HOME}/wabad/v0.1.0/raw/TAM_info_gbif_v2.csv",
            "HUAP": f"{DATA_HOME}/wabad/v0.1.0/raw/HUAP_info_gbif_v2.csv",
            "DONG": f"{DATA_HOME}/wabad/v0.1.0/raw/DONG_info_gbif_v2.csv",
            "CLH": f"{DATA_HOME}/wabad/v0.1.0/raw/CLH_info_gbif_v2.csv",
            "HAR": f"{DATA_HOME}/wabad/v0.1.0/raw/HAR_info_gbif_v2.csv",
            "BOLIN": f"{DATA_HOME}/wabad/v0.1.0/raw/BOLIN_info_gbif_v2.csv",
            "SITH": f"{DATA_HOME}/wabad/v0.1.0/raw/SITH_info_gbif_v2.csv",
            "RBA": f"{DATA_HOME}/wabad/v0.1.0/raw/RBA_info_gbif_v2.csv",
            "MOPU": f"{DATA_HOME}/wabad/v0.1.0/raw/MOPU_info_gbif_v2.csv",
            "CRAT": f"{DATA_HOME}/wabad/v0.1.0/raw/CRAT_info_gbif_v2.csv",
            "PGF": f"{DATA_HOME}/wabad/v0.1.0/raw/PGF_info_gbif_v2.csv",
            "PUUL": f"{DATA_HOME}/wabad/v0.1.0/raw/PUUL_info_gbif_v2.csv",
            "MILLAN": f"{DATA_HOME}/wabad/v0.1.0/raw/MILLAN_info_gbif_v2.csv",
            "BMT": f"{DATA_HOME}/wabad/v0.1.0/raw/BMT_info_gbif_v2.csv",
            "SD": f"{DATA_HOME}/wabad/v0.1.0/raw/SD_info_gbif_v2.csv",
            "UNI": f"{DATA_HOME}/wabad/v0.1.0/raw/UNI_info_gbif_v2.csv",
            "SBN": f"{DATA_HOME}/wabad/v0.1.0/raw/SBN_info_gbif_v2.csv",
            "DUNAS": f"{DATA_HOME}/wabad/v0.1.0/raw/DUNAS_info_gbif_v2.csv",
            "PETI": f"{DATA_HOME}/wabad/v0.1.0/raw/PETI_info_gbif_v2.csv",
            "LIM": f"{DATA_HOME}/wabad/v0.1.0/raw/LIM_info_gbif_v2.csv",
            "BAM": f"{DATA_HOME}/wabad/v0.1.0/raw/BAM_info_gbif_v2.csv",
            "DEVA": f"{DATA_HOME}/wabad/v0.1.0/raw/DEVA_info_gbif_v2.csv",
            "ROTOK": f"{DATA_HOME}/wabad/v0.1.0/raw/ROTOK_info_gbif_v2.csv",
            "CARI": f"{DATA_HOME}/wabad/v0.1.0/raw/CARI_info_gbif_v2.csv",
            "PITI": f"{DATA_HOME}/wabad/v0.1.0/raw/PITI_info_gbif_v2.csv",
            "RME": f"{DATA_HOME}/wabad/v0.1.0/raw/RME_info_gbif_v2.csv",
            "MABI": f"{DATA_HOME}/wabad/v0.1.0/raw/MABI_info_gbif_v2.csv",
            "EMP": f"{DATA_HOME}/wabad/v0.1.0/raw/EMP_info_gbif_v2.csv",
            "EFFOU": f"{DATA_HOME}/wabad/v0.1.0/raw/EFFOU_info_gbif_v2.csv",
        },
        version="0.1.0",
