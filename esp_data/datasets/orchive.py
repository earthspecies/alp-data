...
@register_dataset
class Orchive(Dataset):
    """Orchive dataset

    Description
    -----------
    This dataset contains orca calls and id. The annotated dataset is quite small (372 samples).
    The unsupervised dataset is much larger.

    References
    ----------
    The Orchive: Data mining a massive bioacoustic archive
    Ness, Steven and Symonds, Helena and Spong, Paul and Tzanetakis, George

    DOI 0.48550/arXiv.1307.0589
    https://arxiv.org/abs/1307.0589
    ...
    >>> dataset = Orchive(
    ...     split="test",
    ...     output_take_and_give={"call_type": "label"},
    ...     sample_rate=16000,
    ...     data_root="gs://esp-ml-datasets/orchive/v0.1.0/raw/"
    ... )
    """
    ...
    info = DatasetInfo(
        ...
        owner="marius",
        split_paths={
            "test": "gs://esp-ml-datasets/orchive/v0.1.0/raw/test.csv",
            "train": "gs://esp-ml-datasets/orchive/v0.1.0/raw/train.csv",
            "val": "gs://esp-ml-datasets/orchive/v0.1.0/raw/validation.csv",
            "unsupervised": "gs://esp-ml-datasets/orchive/v0.1.0/raw/unsupervised.csv",
        },
        version="0.1.0",
        description=(
            "Orchive dataset containing orca calls + unannotated calls."
            "The annotated dataset is quite small (372 samples)."
            "The unsupervised dataset is much larger."
            "(Orcinus orca)"
        ),
        sources=["Ness, Steven and Symonds, Helena and Spong, Paul and Tzanetakis, George"],
        license="Unknown",
    )
    ...
    def __init__(
        ...
        """Initialize the Orchive dataset.
    ...
    @classmethod
    def from_config(cls, dataset_config: DatasetConfig) -> tuple["Orchive", dict[str, Any]]:
