...
class DataSynthConversations(Dataset):
    ...
    info = DatasetInfo(
        ...
        split_paths={
            ...
            "t3_with_captions_qa_only_total_assistant40": "gs://foundation-model-data/synthetic/merged/t3_with_captions_qa_only_total_assistant40.parquet",
            "t3_with_captions_qa_only_max4": "gs://foundation-model-data/synthetic/merged/t3_with_captions_qa_only_max4.parquet",
