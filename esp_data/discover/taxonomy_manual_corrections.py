"""
This file implements manual taxonomy corrections that are not accessible
using the logic in GBIFConverter. These corrections are mostly due to
spelling differences not documented by GBIF, and also to taxonomy changes
that happened after GBIF's most recent taxonomy release.
"""
